<div class="grid xl:grid-cols-9 gap-2">
    <div class="text-center leading-tight col-span-3 xl:col-span-2 py-12 border-b xl:border-r xl:border-b-0 border-primary flex-row justify-center items-center">
        <p class="text-center xl:text-bormal text-primary tracking-wide text-sm">
    ...
    <div class="col-span-4 p-4">
        ...
        @auth
            <a class="text-sm text-black btn btn-sm btn-secondary-content hover:underline" href="{{URL::to('/')}}/admin/concerts/{{$concert->id}}/edit"
                class="href">Edit</a>
        @endauth
        ...
        <p class="text-secondary-content text-sm tracking-wider pb-2">
            ΠΡΟΓΡΑΜΜΑ

        </p>
        <p class="text-primary text-sm tracking-normal mb-4">
            {{$concert->program}}
